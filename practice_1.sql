...
(                                                                                             
id serial primary key  ,   --serial id'yi aouto increment gibi otomatik artirir                                                                   
isim varchar(20),                                                                             
yas int,                                                                                      
maas int,                                                                                     
email varchar(30)                                                                             
...
select * from personel where isim ilike 'A%' --% ne ile devam ederse etsin 
...
select * from personel where yas not between (3 and 40)
...
select * from personel order by where yas ;--dogal siralamasi kucukten buyuge asc
